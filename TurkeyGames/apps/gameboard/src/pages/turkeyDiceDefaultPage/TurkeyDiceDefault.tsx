...
export default function TurkeyDiceDefault(props: propsType) {
  ...
  const [areaPlayers, setAreaPlayers] = useState<(number | null)[]>([
    null,
    null,
    null,
    null,
